...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Alarm_t, stringdata0) + ofs), len 
...
const QMetaObject Alarm::staticMetaObject = { {
    ...
    qt_meta_stringdata_Alarm.offsetsAndSize,
    qt_meta_data_Alarm,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Alarm_t
